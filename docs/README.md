...
| [Post-Launch Roadmap](POST_LAUNCH.md) | **Current** prioritized roadmap after v1.0 launch — daily challenge, leaderboard, vs-replays, dynamic OG, and the Rewriting History (v2.0) plan. Supersedes most of next-upgrades.md |
| [Next Upgrades](next-upgrades.md) | Deeper engineering backlog (data fidelity, a11y, perf, offline) — partially superseded by POST_LAUNCH.md |
| [v2 Upgrade Plan](V2_UPGRADE_PLAN.md) | Coordinator spec for the "make it premium" pass — parallel workstreams (ratings, design system, silhouette, screens, flow) with disjoint file ownership + launcher prompts |
